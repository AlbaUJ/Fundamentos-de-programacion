...
num_payasos = int(input("dime la cantidad de payasos del pedido: "))
num_muñecas = int(input("dime la cantidad de muñecas del pedido: "))

Peso_payasos = 112 #gramos
Peso_muñecas = 75  #gramos

total_payasos = num_payasos * Peso_payasos
total_muñecas = num_muñecas * Peso_muñecas

pedido = total_payasos + total_muñecas

print (f"El peso total del paquete que será enviado es de {pedido} gramos")